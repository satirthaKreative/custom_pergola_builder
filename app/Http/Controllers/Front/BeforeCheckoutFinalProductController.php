...
class BeforeCheckoutFinalProductController extends Controller
{
    ...
    public function saveData(Request $request)
    {
        ...
        {
            $insertQuery = [
                'final_wood' => $_GET['main_wood_type'],
		        ...
		        'lpanel_side1' => $_GET['lpanel_side1'], 
                'lpanel_side2' => $_GET['lpanel_side2'], 
                'lpanel_side3' => $_GET['lpanel_side3'], 
                'lpanel_side4' => $_GET['lpanel_side4'], 
                'lpanel_side5' => $_GET['lpanel_side5'], 
                'lpanel_side6' => $_GET['lpanel_side6'], 
                'lpanel_side7' => $_GET['lpanel_side7'], 
                'lpanel_side8' => $_GET['lpanel_side8'], 
		        'slap_type_id' => $_GET['mount_brackets_type'],
    ...
    public function generate_pdf(Request $request) 
	{
        ...
        foreach($mainQuery as $mQuery)
        {
            ...
            // mount query
            $final_mount_system = $mQuery->final_post_mount_type;
            
            if($mQuery->final_post_mount == 0)
            {
                $final_mount_system = "No";
            }
            $data['mount_count'] = ucwords($final_mount_system);
		...
		$pdf = PDF::loadView('frontend.pages.pdf-last-modified-docx', $data);
