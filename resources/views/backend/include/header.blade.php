  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item has-treeview">
          <a href="javascript: ;" class="nav-link @if($page == 'config-panel') active @endif">
            <i class="nav-icon fas fa-edit"></i>
            <p>
            Config Panel
              <i class="fas fa-angle-left right"></i>
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="{{ route('admin.admin-config-page-show') }}" class="nav-link @if($page == 'config-panel') active @endif">
                <i class="far fa-circle nav-icon"></i>
                <p>View Config Panel</p>
              </a>
            </li>
          </ul>
        </li>
        ...
        <li class="nav-item has-treeview">
          <a href="javascript: ;" class="nav-link @if($page == 'post-wish-canopy-view' || $page == 'post-wish-louvered-view' || $page == 'mount-bracket-all') active @endif">
            <i class="nav-icon fas fa-edit"></i>
            <p>
            Post Wish Panel
              <i class="fas fa-angle-left right"></i>
          ...
          <ul class="nav nav-treeview">
            <!-- canopy panel -->
            <li class="nav-item">
              <a href="{{ route('admin.post-wish-canopy') }}" class="nav-link @if($page == 'post-wish-canopy-view') active @endif">
                <i class="far fa-circle nav-icon"></i>
                <p>Setup Canopy Panel</p>
              </a>
            </li>

            <!-- lpanel Panel -->
            <li class="nav-item">
              <a href="{{ route('admin.post-wish-lpanel') }}" class="nav-link @if($page == 'post-wish-louvered-view') active @endif">
                <i class="far fa-circle nav-icon"></i>
                <p>Setup Louvered Panel</p>
              </a>
            </li>	    <!-- mount bracket Panel -->            <li class="nav-item">              <a href="{{ route('admin.setup.mount-bracket-all') }}" class="nav-link @if($page == 'mount-bracket-all') active @endif">                <i class="far fa-circle nav-icon"></i>                <p>Setup Mount Bracket</p>              </a>            </li>
          </ul>
        </li>
