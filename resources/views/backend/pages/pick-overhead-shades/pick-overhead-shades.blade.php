          ...
          <div class="card card-primary">
            ...
            @csrf
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  <label for="ladder-spacing-id">Wood Types *</label>
                ...
                <div class="form-group">
                  ...
                  <select required class="form-control" name="master_post" id="master-post-id" placeholder="Enter post" onclick="master_post_change_fx()">
                    <option value="">Choose master posts</option>
                  </select>
                </div>
                <div class="form-group">
                  <label for="ladder-spacing-id">Ladder Spacing *</label>
                  <select required class="form-control" name="ladder_spacing"  onchange="master_overhead_config_change_fx()"  id="ladder-spacing-id" placeholder="Enter ladder spacing">
                    <option value="">Choose ladder spacing</option>
                  </select>
                </div>
                <!-- <div class="form-group"> -->
                  <!-- <label for="ladder-spacing-price-id">Ladder Spacing Price *</label> -->
                  <input type="hidden" class="form-control" name="ladder_spacing_price" id="ladder-spacing-price-id" placeholder="Enter ladder spacing price">
                <!-- </div> -->
                <div class="form-group">
...
<script>
    ...
    function master_overhead_config_change_fx()
    {
      ...
      if(master_width != "" && master_height != "" && master_post != "" && master_overhead != "")
      {
        $.ajax({
          url: "{{ route('admin.show-pick-a-overhead-shades-config') }}",
          type: "GET",
          data: {post_id: master_post, width_val: master_width, height_val: master_height, master_overhead: master_overhead},
          dataType: "json",
    ...
    function master_width_onchange()
    {
      ...
      if(w_id != "" && w_id != null && h_id != "" && h_id != null && wood_id != "" && wood_id != null)
      {
        $.ajax({
    ...
    function load_overhead_shades_fx()
    {
      $.ajax({
        ...
        success: function(event){
          ...
          $("#wood-types-name-id").html(event.master_woodtypes);
        }, error: function(event){
    ...
    function make_edit_change(id)
    {
        ...
        $.ajax({
            ...
            success: function(event){
                ...
                $("#ladder-spacing-id").html(event.master_overhead);
                $("#wood-types-name-id").html(event.master_wood);
                $("#master-post-id").html(event.master_posts);
                ...
                load_edit_overhead_shades_onchange_fx();
            }, error: function(event){
    ...
    function load_edit_overhead_shades_onchange_fx()
    {
      var master_width = $("#master-width-id").val();
      var master_height = $("#master-height-id").val();
      var master_post = $("#master-post-id").val();
    ...
    function master_post_change_fx(){
      var master_width = $("#master-width-id").val();
      var master_height = $("#master-height-id").val();
      var master_post = $("#master-post-id").val();
      var master_overhead = $("#ladder-spacing-id").val();
