            ...
            <div class="card-body table-responsive scroll-demo-table p-0">
              <table class="table table-hover text-nowrap" >
                ...
                <tbody id="campaign-tbl-id">
                  <tr>
                    <td colspan="9"><center class="text-info"><i class="fa fa-spinner"></i> Loading data's</center></td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            @csrf
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <select required class="form-control" name="wood_types_name" id="wood-types-name-id">
    ...
    function loading_3d_form()
    {
        $.ajax({
            ...
            success: function(event){
              ...
              $("#wood-types-name-id").html(event.master_wood_types_name);
            }, error: function(event){
