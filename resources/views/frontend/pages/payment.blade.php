  ...
  <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 col-sm-6 pay_right">
          ...
          <div class="term">
            <label><input type="checkbox" name="option-2"> I have read and agree to the website <a target="_blank" href="https://outdoorlivingtoday.com/terms-and-conditions/">terms and conditions</a> <span>*</span></label>
...
<script>
    ...
    $("#place-order-submit-btn-id").on('click',function(e){
      ...
      var email_name = $("#email-id").val();	var extra_note = $("#order-notes-id").val();
