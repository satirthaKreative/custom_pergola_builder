                    ...
                    <div class="col-lg-6 Louvered-sec">
                        ...
                        <ul class="Canopy1 Canopy-2 checking-radio-panel-of-lpanel1-class">
                            ...
                            <li>
                                ...
                                <input type="radio" name="bracket3" value="yes" class="pick-lpanel-yes-type-new" disabled>Yes
...

{
    ...
    $.ajax({
        ...
        success: function(event) {
            ...
            console.log("pick slap video : "+event.choose_pick_slap_html);
