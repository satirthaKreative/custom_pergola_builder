...
<style>
#mount-bracket-anchor-paragraph-id > a{
    color: #7a9739;
    text-transform: uppercase;
    font-weight: bold;
}
#post-canopy-anchor-paragraph-id > a{
    color: #7a9739;
    text-transform: uppercase;
    font-weight: bold;
}
#post-lpanel-anchor-paragraph-id > a{
    color: #7a9739;
    text-transform: uppercase;
    font-weight: bold;
}
div#new-post-canopy-img-Qid {
    margin: 25px 0;
    background: #fff;
    box-shadow: 0 0 3px #0000001a;
    border: 10px solid #fff;
}
div#new-post-lpanel-img-Qid {
    margin: 25px 0;
    background: #fff;
    box-shadow: 0 0 3px #0000001a;
    border: 10px solid #fff;
...
/* btn color */
#multiple-cc-emails-clear-btn-id{
    background-color: #7a9739;
    color: #ffffff;
    font-weight: bold;
    border: none;
}
#multiple-cc-emails-clear-btn-id:hover {
    background-color: #e2e8d7;
    color: #000;
    font-weight: bold;
    border: none;
}
#multiple-cc-emails-add-btn-id{
    background-color: #7a9739;
    color: #ffffff;
    font-weight: bold;
    border: none;
}
#multiple-cc-emails-add-btn-id:hover {
    background-color: #e2e8d7;
    color: #000;
    font-weight: bold;
    border: none;
}
#first-pergola-email-submit-id{
    background-color: #7a9739;
    color: #ffffff;
    width: 100%;
    font-weight: bold;
...
button#first-pergola-email-submit-id:hover {
    background-color: #e2e8d7;
    color: #000;
    font-weight: bold;
    border: none;
...
#multiple-cc-emails2-clear-btn-id{
    background-color: #7a9739;
    color: #ffffff;
    font-weight: bold;
    border: none;
}
#multiple-cc-emails2-clear-btn-id:hover {
    background-color: #e2e8d7;
    color: #000;
    font-weight: bold;
    border: none;
}
#multiple-cc-emails2-add-btn-id{
    background-color: #7a9739;
    color: #ffffff;
    font-weight: bold;
    border: none;
}
#multiple-cc-emails2-add-btn-id:hover {
    background-color: #e2e8d7;
    color: #000;
    font-weight: bold;
    border: none;
}
#second-pergola-email-submit-id{
    background-color: #7a9739;
    color: #ffffff;
    width: 100%;
    font-weight: bold;
...
button#second-pergola-email-submit-id:hover {
    background-color: #e2e8d7;
    color: #000;
    font-weight: bold;
    border: none;
                ...
                <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <select name="" id="mount-brackets-datas-show-id" onchange="mount_brackets_type_change_fx()">
                                ...
                                <option value="2">Existing slab setup</option>
                            </select>
                            <p id="mount-bracket-type-wish-text-id">
                            </p>
                            <p id="mount-bracket-anchor-paragraph-id"></p>
            ...
            <fieldset>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 ">       
                        ...
                        <p id="post-canopy-anchor-paragraph-id"></p>
                    ...
                    <div class="col-lg-6">
                        <div class="video-wrap">
                            ...
                            <div id="new-post-canopy-img-Qid">
            ...
            <fieldset>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 Louvered-sec">
                        ...
                        <p id="post-lpanel-anchor-paragraph-id"></p>
                        ...
                        <div id="lpanel-checkbox-id" style="display: none">
                            ...
                            <input type="hidden" id="lpanel-checkbox-side5-count-id" name="lpanel_checkbox_count_side5_name" value="0" />
                            <input type="hidden" id="lpanel-checkbox-side6-count-id" name="lpanel_checkbox_count_side6_name" value="0" />
                            <input type="hidden" id="lpanel-checkbox-side7-count-id" name="lpanel_checkbox_count_side7_name" value="0" />
                            <input type="hidden" id="lpanel-checkbox-side8-count-id" name="lpanel_checkbox_count_side8_name" value="0" />
                            <div class="long-lpanel-checkbox-count-id">
                                
                            </div>
                            <div class="short-lpanel-checkbox-count-id">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div id="new-post-lpanel-img-Qid">
            ...
            <fieldset>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 text-center">
                        ...
                        <h2>Custom Pergola Builder</h2>
                        <div class="last-footprint-img-class"></div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9"><input type="text" id="send-form-name-id"></div>

                    <div class="col-lg-3"><label for="">Email</label></div>

                    <div class="col-lg-9"><input type="email" id="send-form-email-id"></div>

                    <div class="col-lg-3"><label for="">Others Email</label></div>
                    <div class="col-lg-5"><input type="email" id="send-form-cc-email-id" /></div>
                    <div class="col-lg-2"><input type="button" onclick="send_form_cc_email_fx('add')" id="multiple-cc-emails-add-btn-id" value="Add"/></div>
                    <div class="col-lg-2"><input type="button" onclick="send_form_cc_email_fx('clear')" id="multiple-cc-emails-clear-btn-id" value="Clear"/></div>

                    <div class="col-lg-3"></div>
                    <div class="col-lg-9">
                        <input type="hidden" name="send_cc_emails_others" id="send-cc-emails-others-id" value="0"/>
                        <div class="send-cc-email-div"></div>
                    </div>

                    <div class="col-lg-3"><label for="">Comment</label></div>
                    <div class="col-lg-9"><textarea name="" id="send-form-comment-id"></textarea></div>

                    <div class="col-lg-12"><button type="button" onclick="submit_Send_mail_fx()" id="first-pergola-email-submit-id"><i class='fa fa-paper-plane'></i> Send Mail</button></div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3"><label for="">Others Email</label></div>
                    <div class="col-lg-5"><input type="email" id="send-form-cc-email2-id" /></div>
                    <div class="col-lg-2"><input type="button" onclick="send_form_cc_email2_fx('add')" id="multiple-cc-emails2-add-btn-id" value="Add"/></div>
                    <div class="col-lg-2"><input type="button" onclick="send_form_cc_email2_fx('clear')" id="multiple-cc-emails2-clear-btn-id" value="Clear"/></div>

                    <div class="col-lg-3"></div>
                    <div class="col-lg-9">
                        <input type="hidden" name="send_cc_emails2_others" id="send-cc-emails2-others-id" value="0"/>
                        <div class="send-cc-email2-div"></div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <button type="button" onclick="submit_Send_mail_fx1()" id="second-pergola-email-submit-id"><i class='fa fa-paper-plane'></i> Send Mail</button>
                    </div>
...
<!-- mount read more popup window -->

<div class="modal fade email-modal" id="myModal-mount-bracket">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Mount Bracket</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="mount-bracket-paragraph-details-class">
...
<div class="modal fade email-modal" id="myModal-post-canopy">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Post Canopy</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="post-canopy-paragraph-details-class">
...
<div class="modal fade email-modal" id="myModal-post-lpanel">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Louvered Panel</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="post-lpanel-paragraph-details-class">
    ...
    $.ajax({
        ...
        success: function(event) {
            ...
            if(event.mount_price_html == 0)
            {
                ...
                $("#mount-brackets-datas-show-id").html('<option value="">Choose a mount brackets</option><option value="1">Concrete setup</option><option value="2">Existing slab setup</option>');
                ...
                if(event.video_link_id != null)
                {
                    
                    $("#mount-bracket-video-id").css('display','block');
                    $("#mount-bracket-video-id").html('<video width="1280" height="720" controls><source src="'+event.video_link+'" type="video/mp4"></video>');
                }
                else 
                {
                    $("#mount-bracket-video-id").css('display','none');
                    $("#mount-bracket-video-id").html('');
                }


                if(event.image_link_id != null)
                {
                    $("#new-mount-bracket-img-Qid").css('display','block');
                ...
                {
                    $("#new-mount-bracket-img-Qid").css('display','none');
                    $("#new-mount-bracket-img-Qid").html('');
                }
            ...
            else
            {
                ...
                {
                    $("#mount-brackets-datas-show-id").html('<option value="">Choose a post mount brackets</option><option value="1" selected>Concrete setup</option><option value="2">Existing slab setup</option>');
                    var mountB = "Concrete Setup*";
                }
                else if(event.show_mount_slap_types == 2)
                {
                    $("#mount-brackets-datas-show-id").html('<option value="">Choose a post mount brackets</option><option value="1">Concrete setup</option><option value="2" selected>Existing slab setup</option>');
                    var mountB = "Existing Slab Setup*";
                }
            ...
            if(event.my_latest_canopy_type_check == "yes")
            {
                ...
                if(event.canopy_video_link_id != null)
                {
                    $("#youtube-canopy-video-id").css('display','block');
                    $("#youtube-canopy-video-id").html('<video width="1280" height="720" controls><source src="'+event.canopy_video_link+'" type="video/mp4"></video>');
                }
                else 
                {
                    $("#youtube-canopy-video-id").css('display','none');
                    $("#youtube-canopy-video-id").html('');
                }


                if(event.canopy_image_link_id != null)
                {
                    $("#new-post-canopy-img-Qid").css('display','block');
                    $("#new-post-canopy-img-Qid").html('<img loading="lazy" src="'+event.canopy_image_link+'" style="margin-bottom: 0; box-shadow: 0 0 3px rgba(0,0,0,0.1); border: 10px solid #fff;" alt="post mount brackets" width="428" height="257" class="aligncenter size-full wp-image-3479">');
                }
                else 
                {
                    $("#new-post-canopy-img-Qid").css('display','none');
                    $("#new-post-canopy-img-Qid").html('');
                }
            }
            else if(event.my_latest_canopy_type_check == "no")
            {
                ...
                {
                    $("#new-post-canopy-img-Qid").css('display','block');
                    $("#new-post-canopy-img-Qid").html('<img loading="lazy" src="'+event.canopy_image_link+'"  alt="post mount brackets" width="428" height="257" class="aligncenter size-full wp-image-3479">');
                }
                else 
                {
                    $("#new-post-canopy-img-Qid").css('display','none');
            ...
            // end canopy
            console.log('lpanel1'+event.lpanel_checking_piller);
            ...
            if(event.show_lpanel_type == "yes")
            {
                ...
                if(event.lpanel_side5 == 1)
                {
                    $("#s5-lpanel-id").prop('checked',true);
                    $("#lpanel-checkbox-side5-count-id").val(1);
                }
                else
                {
                    $("#s5-lpanel-id").prop('checked',false);
                    $("#lpanel-checkbox-side5-count-id").val(0);
                }

                if(event.lpanel_side6 == 1)
                {
                    $("#s6-lpanel-id").prop('checked',true);
                    $("#lpanel-checkbox-side6-count-id").val(1);
                }
                else
                {
                    $("#s6-lpanel-id").prop('checked',false);
                    $("#lpanel-checkbox-side6-count-id").val(0);
                }

                if(event.lpanel_side7 == 1)
                {
                    $("#s7-lpanel-id").prop('checked',true);
                    $("#lpanel-checkbox-side7-count-id").val(1);
                }
                else
                {
                    $("#s7-lpanel-id").prop('checked',false);
                    $("#lpanel-checkbox-side7-count-id").val(0);
                }

                if(event.lpanel_side8 == 1)
                {
                    $("#s8-lpanel-id").prop('checked',true);
                    $("#lpanel-checkbox-side8-count-id").val(1);
                }
                else
                {
                    $("#s8-lpanel-id").prop('checked',false);
                    $("#lpanel-checkbox-side8-count-id").val(0);
                }
                ...
                setTimeout(() => {
                    var event_lpanel_side1 = event.lpanel_side1;
                    var event_lpanel_side2 = event.lpanel_side2;
                    var event_lpanel_side3 = event.lpanel_side3;
                    var event_lpanel_side4 = event.lpanel_side4;
                    var event_lpanel_side5 = event.lpanel_side5;
                    var event_lpanel_side6 = event.lpanel_side6;
                    var event_lpanel_side7 = event.lpanel_side7;
                    var event_lpanel_side8 = event.lpanel_side8;
                    load_louvered_panel_session_new_single_fx(event_lpanel_side1,event_lpanel_side2,event_lpanel_side3,event_lpanel_side4,event_lpanel_side5,event_lpanel_side6,event_lpanel_side7,event_lpanel_side8);

                    

                    var side01 = $("#lpanel-checkbox-side1-count-id").val();
                    var side02 = $("#lpanel-checkbox-side2-count-id").val();
                    var side03 = $("#lpanel-checkbox-side3-count-id").val();
                    var side04 = $("#lpanel-checkbox-side4-count-id").val();
                    var side05 = $("#lpanel-checkbox-side5-count-id").val();
                    var side06 = $("#lpanel-checkbox-side6-count-id").val();
                    var side07 = $("#lpanel-checkbox-side7-count-id").val();
                    var side08 = $("#lpanel-checkbox-side8-count-id").val();

                    var piller_counts = event.lpanel_checking_piller;

                    if(piller_counts == 1)
                    {
                        var total_side = parseInt(side01)+parseInt(side02)+parseInt(side03)+parseInt(side04);
                        if(total_side >= 3)
                        {
                            if(side01 == 0)
                            {
                                $("#left-lpanel-id").prop('disabled',true);
                            }
                            else if(side02 == 0)
                            {
                                $("#right-lpanel-id").prop('disabled',true);
                            }
                            else if(side03 == 0)
                            {
                                $("#front-lpanel-id").prop('disabled',true);
                            }
                            else if(side04 == 0)
                            {
                                $("#rear-lpanel-id").prop('disabled',true);
                            }
                        }
                        else if(total_side < 3)
                        {
                            if(side01 == 0)
                            {
                                $("#left-lpanel-id").prop('disabled',false);
                            }
                            if(side02 == 0)
                            {
                                $("#right-lpanel-id").prop('disabled',false);
                            }
                            if(side03 == 0)
                            {
                                $("#front-lpanel-id").prop('disabled',false);
                            }
                            if(side04 == 0)
                            {
                                $("#rear-lpanel-id").prop('disabled',false);
                            }
                        }
                    }
                    else if(piller_counts == 2)
                    {
                        var total_side = parseInt(side01)+parseInt(side02)+parseInt(side03)+parseInt(side04);
                        if(total_side >= 3)
                        {
                    ...
                    else if(piller_counts == 5)
                    {
                        var total_side = parseInt(side01)+parseInt(side02)+parseInt(side03)+parseInt(side04)+parseInt(side05)+parseInt(side06);
                        if(total_side >= 5)
                        {
                            if(side01 == 0)
                            {
                            ...
                            {
                                $("#s5-lpanel-id").prop('disabled',true);
                            }
                            else if(side06 == 0)
                            {
                                $("#s6-lpanel-id").prop('disabled',true);
                            }
                        }
                        else if(total_side < 5)
                        {
                            if(side01 == 0)
                            {
                                $("#left-lpanel-id").prop('disabled',false);
                            ...
                            if(side05 == 0)
                            {
                                $("#s5-lpanel-id").prop('disabled',false);
                            }
                            if(side06 == 0)
                            {
                                $("#s6-lpanel-id").prop('disabled',false);
                            }
                        }
                    }
                    else if(piller_counts == 4)
                    {
                        var total_side = parseInt(side01)+parseInt(side02)+parseInt(side03)+parseInt(side04)+parseInt(side05)+parseInt(side06)+parseInt(side07)+parseInt(side08);
                        if(total_side >= 7)
                        {
                            if(side01 == 0)
                            {
                            ...
                            {
                                $("#s7-lpanel-id").prop('disabled',true);
                            }
                            else if(side08 == 0)
                            {
                                $("#s8-lpanel-id").prop('disabled',true);
                            }
                        }
                        else if(total_side < 7)
                        {
                            if(side01 == 0)
                            {
                                $("#left-lpanel-id").prop('disabled',false);
                            ...
                            if(side07 == 0)
                            {
                                $("#s7-lpanel-id").prop('disabled',false);
                            }
                            if(side08 == 0)
                            {
                                $("#s8-lpanel-id").prop('disabled',false);
                            }
                        }
                    }
                }, 2000);
                
                if(event.lpanel_video_link_id != null)
                {
                    $("#youtube-lpanel-video-id").css('display','block');
                    $("#youtube-lpanel-video-id").html('<video width="1280" height="720" controls><source src="'+event.lpanel_video_link+'" type="video/mp4"></video>');
                }
                else 
                {
                    $("#youtube-lpanel-video-id").css('display','none');
                    $("#youtube-lpanel-video-id").html('');
                }


                if(event.lpanel_image_link_id != null)
                {
                    $("#new-post-lpanel-img-Qid").css('display','block');
                    $("#new-post-lpanel-img-Qid").html('<img loading="lazy" src="'+event.lpanel_image_link+'" alt="post mount brackets" width="428" height="257" class="aligncenter size-full wp-image-3479">');
                }
                else 
                {
                    $("#new-post-lpanel-img-Qid").css('display','none');
                    $("#new-post-lpanel-img-Qid").html('');
                }
            ...
            else if(event.show_lpanel_type == "no")
            {
                ...
                else 
                {
                    ...
                    if(event.popup_name != null && event.popup_details != null)
                    {
                        $("#mount-bracket-anchor-paragraph-id").html('<a href="javascript:;" onclick="mount_popup_modal('+event.popup_id+')">'+event.popup_name+'</a>');
                        // $("#myModal-mount-bracket").modal('show');
                        $(".mount-bracket-paragraph-details-class").html(event.popup_details);
                    }

                    if(event.canopy_popup_name != null && event.canopy_popup_details != null)
                    {
                        $("#post-canopy-anchor-paragraph-id").html('<a href="javascript:;" onclick="canopy_popup_modal('+event.canopy_popup_id+')">'+event.canopy_popup_name+'</a>');
                        // $("#myModal-mount-bracket").modal('show');
                        $(".post-canopy-paragraph-details-class").html(event.canopy_popup_details);
                    }


                    if(event.lpanel_popup_name != null && event.lpanel_popup_details != null)
                    {
                        $("#post-lpanel-anchor-paragraph-id").html('<a href="javascript:;" onclick="louvered_popup_modal('+event.lpanel_popup_id+')">'+event.lpanel_popup_name+'</a>');
                        // $("#myModal-mount-bracket").modal('show');
                        $(".post-lpanel-paragraph-details-class").html(event.lpanel_popup_details);
                    }
...
function load_louvered_panel_session_new_single_fx(e1, e2, e3, e4, e5, e6, e7, e8)
{
    ...
    var piller_counts = $("#master-home-post-id").val();
    $.ajax({
        url: "{{ route('satirtha.louvered-panel-yes-shown') }}",
        type: "GET",
        data: {wood_type: wood_type, width_type: width_type, height_type: height_type, post_length: post_length, piller_counts: piller_counts },
        dataType: "json",
        success: function(event){
            ...
            {
                //  4 posts 
                    $(".long-lpanel-checkbox-count-id").html('  <label for="long-lpanel-id" id="long-lpanel-id"> Long Sides:</label><input type="checkbox" id="left-lpanel-id" name="left_lpanel_name" onclick="" value="side1"><label for="left-lpanel-id" id="side1-lpanel-id"> Side A</label>  <input type="checkbox" id="front-lpanel-id" name="front_lpanel_name" onclick="" value="side3"><label for="front-lpanel-id" id="side3-lpanel-id"> Side C</label>');
                    $(".short-lpanel-checkbox-count-id").html('  <label for="short-lpanel-id" id="short-lpanel-id"> Short Sides:</label><input type="checkbox" id="right-lpanel-id" name="right_lpanel_name" onclick="" value="side2"><label for="right-lpanel-id" id="side2-lpanel-id"> Side B</label>  <input type="checkbox" id="rear-lpanel-id" name="rear_lpanel_name" onclick="" value="side4"><label for="rear-lpanel-id" id="side4-lpanel-id"> Side D</label>');
                    $("#side1-lpanel-id").html(" Side A ("+event.side13+" Price: "+event.side13_price+") ");
                    $("#left-lpanel-id").attr('onclick','checkbox_lpanel_fx("side1",'+event.side13_price+')');
                    $("#side2-lpanel-id").html(" Side B ("+event.side24+" Price: "+event.side24_price+") ");
                    $("#right-lpanel-id").attr('onclick','checkbox_lpanel_fx("side2",'+event.side24_price+')');
                    $("#side3-lpanel-id").html(" Side C ("+event.side13+" Price: "+event.side13_price+") ");
                    $("#front-lpanel-id").attr('onclick','checkbox_lpanel_fx("side3",'+event.side13_price+')');
                    $("#side4-lpanel-id").html(" Side D ("+event.side24+" Price: "+event.side24_price+") ");
            ...
            else if(piller_counts == 2)
            {
                ...
                $(".long-lpanel-checkbox-count-id").html('  <label for="long-lpanel-id" id="long-lpanel-id"> Long Sides:</label><input type="checkbox" id="left-lpanel-id" name="left_lpanel_name" onclick="" value="side1"><label for="left-lpanel-id" id="side1-lpanel-id"> Side A</label>  <input type="checkbox" id="front-lpanel-id" name="front_lpanel_name" onclick="" value="side3"><label for="front-lpanel-id" id="side3-lpanel-id"> Side C</label>');
                    $(".short-lpanel-checkbox-count-id").html('  <label for="short-lpanel-id" id="short-lpanel-id"> Short Sides:</label><input type="checkbox" id="right-lpanel-id" name="right_lpanel_name" onclick="" value="side2"><label for="right-lpanel-id" id="side2-lpanel-id"> Side B</label>  <input type="checkbox" id="rear-lpanel-id" name="rear_lpanel_name" onclick="" value="side4"><label for="rear-lpanel-id" id="side4-lpanel-id"> Side D</label>');
                    $("#side1-lpanel-id").html(" Side A");
                    $("#left-lpanel-id").attr('onclick','checkbox_lpanel_fx("side1",'+event.side13_price+')');
                    $("#side2-lpanel-id").html(" Side B");
                    $("#right-lpanel-id").attr('onclick','checkbox_lpanel_fx("side2",'+event.side24_price+')');
                    $("#side3-lpanel-id").html(" Side C");
                    $("#front-lpanel-id").attr('onclick','checkbox_lpanel_fx("side3",'+event.side13_price+')');
                    $("#side4-lpanel-id").html(" Side D");
                    $("#rear-lpanel-id").attr('onclick','checkbox_lpanel_fx("side4",'+event.side24_price+')');
                    if(e1 == 1)
                    {
                        $("#left-lpanel-id").prop('checked',true);
            ...
            {
                //  6 posts 
                $(".long-lpanel-checkbox-count-id").html('  <label for="long-lpanel-id" id="long-lpanel-id"> Long Sides:</label><input type="checkbox" id="left-lpanel-id" name="left_lpanel_name" onclick="" value="side1"><label for="left-lpanel-id" id="side1-lpanel-id"> Side A</label>  <input type="checkbox" id="right-lpanel-id" name="right_lpanel_name" onclick="" value="side2"><label for="right-lpanel-id" id="side2-lpanel-id"> Side B</label>  <input type="checkbox" id="front-lpanel-id" name="front_lpanel_name" onclick="" value="side3"><label for="front-lpanel-id" id="side3-lpanel-id"> Side C</label>  <input type="checkbox" id="rear-lpanel-id" name="rear_lpanel_name" onclick="" value="side4"><label for="rear-lpanel-id" id="side4-lpanel-id"> Side D</label>');
                    $(".short-lpanel-checkbox-count-id").html('  <label for="short-lpanel-id" id="short-lpanel-id"> Short Sides:</label><input type="checkbox" id="s5-lpanel-id" name="s5_lpanel_name" onclick="" value="side5"><label for="right-lpanel-id" id="side5-lpanel-id"> Side E</label>  <input type="checkbox" id="s6-lpanel-id" name="s6_lpanel_name" onclick="" value="side6"><label for="s6-lpanel-id" id="side6-lpanel-id"> Side F</label>');
                    $("#side1-lpanel-id").html(" Side A");
                    $("#left-lpanel-id").attr('onclick','checkbox_lpanel_fx("side1",'+event.side13_price+')');
                    $("#side2-lpanel-id").html(" Side B");
                    $("#right-lpanel-id").attr('onclick','checkbox_lpanel_fx("side2",'+event.side13_price+')');
                    $("#side3-lpanel-id").html(" Side C");
                    $("#front-lpanel-id").attr('onclick','checkbox_lpanel_fx("side3",'+event.side13_price+')');
                    $("#side4-lpanel-id").html(" Side D");
                    $("#rear-lpanel-id").attr('onclick','checkbox_lpanel_fx("side4",'+event.side13_price+')');
                    $("#side5-lpanel-id").html(" Side E");
                    $("#s5-lpanel-id").attr('onclick','checkbox_lpanel_fx("side5",'+event.side24_price+')');
                    $("#side6-lpanel-id").html(" Side F");
                    $("#s6-lpanel-id").attr('onclick','checkbox_lpanel_fx("side6",'+event.side24_price+')');
                    if(e1 == 1)
                    {
                        $("#left-lpanel-id").prop('checked',true);
                        $("#lpanel-checkbox-side1-count-id").val(1);
            ...
            {
                //  8 posts 
                $(".long-lpanel-checkbox-count-id").html('  <label for="long-lpanel-id" id="long-lpanel-id"> Long Sides:</label><input type="checkbox" id="left-lpanel-id" name="left_lpanel_name" onclick="" value="side1"><label for="left-lpanel-id" id="side1-lpanel-id"> Side A</label>  <input type="checkbox" id="right-lpanel-id" name="right_lpanel_name" onclick="" value="side2"><label for="right-lpanel-id" id="side2-lpanel-id"> Side B</label>  <input type="checkbox" id="front-lpanel-id" name="front_lpanel_name" onclick="" value="side3"><label for="front-lpanel-id" id="side3-lpanel-id"> Side C</label>  <input type="checkbox" id="rear-lpanel-id" name="rear_lpanel_name" onclick="" value="side4"><label for="rear-lpanel-id" id="side4-lpanel-id"> Side D</label> <input type="checkbox" id="s5-lpanel-id" name="s5_lpanel_name" onclick="" value="side5"><label for="right-lpanel-id" id="side5-lpanel-id"> Side E</label>  <input type="checkbox" id="s6-lpanel-id" name="s6_lpanel_name" onclick="" value="side6"><label for="s6-lpanel-id" id="side6-lpanel-id"> Side F</label>');
                    $(".short-lpanel-checkbox-count-id").html('  <label for="short-lpanel-id" id="short-lpanel-id"> Short Sides:</label><input type="checkbox" id="s7-lpanel-id" name="s7_lpanel_name" onclick="" value="side7"><label for="right-lpanel-id" id="side7-lpanel-id"> Side G</label>  <input type="checkbox" id="s8-lpanel-id" name="s8_lpanel_name" onclick="" value="side8"><label for="s8-lpanel-id" id="side8-lpanel-id"> Side H</label>');
                    $("#side1-lpanel-id").html(" Side A");
                    $("#left-lpanel-id").attr('onclick','checkbox_lpanel_fx("side1",'+event.side13_price+')');
                    $("#side2-lpanel-id").html(" Side B");
                    $("#right-lpanel-id").attr('onclick','checkbox_lpanel_fx("side2",'+event.side13_price+')');
                    ...
                    $("#rear-lpanel-id").attr('onclick','checkbox_lpanel_fx("side4",'+event.side13_price+')');
                    $("#side5-lpanel-id").html(" Side E");
                    $("#s5-lpanel-id").attr('onclick','checkbox_lpanel_fx("side5",'+event.side13_price+')');
                    $("#side6-lpanel-id").html(" Side F");
                    $("#s6-lpanel-id").attr('onclick','checkbox_lpanel_fx("side6",'+event.side13_price+')');
                    $("#side7-lpanel-id").html(" Side G");
                    $("#s7-lpanel-id").attr('onclick','checkbox_lpanel_fx("side7",'+event.side24_price+')');
                    $("#side8-lpanel-id").html(" Side H");
                    $("#s8-lpanel-id").attr('onclick','checkbox_lpanel_fx("side8",'+event.side24_price+')');
                    if(e1 == 1)
                    {
                        $("#left-lpanel-id").prop('checked',true);
                        $("#lpanel-checkbox-side1-count-id").val(1);
...

{
    ...
    {
        info = [];
        var cc_count = $("#send-cc-emails-others-id").val();
        if(cc_count > 0)
        {
            for(var i = 0; i < cc_count; i++)
            {
                info[i] =  $("input[name='send_cc_emails_name"+(parseInt(i)+parseInt(1))+"']").val();
            }
        }
...
function submit_Send_mail_fx1()
{
    ...
    if (uname == ""){
        ...
        info = [];
        var cc_count = $("#send-cc-emails2-others-id").val();
        if(cc_count > 0)
        {
            for(var i = 0; i < cc_count; i++)
            {
                info[i] =  $("input[name='send_cc_emails2_name"+(parseInt(i)+parseInt(1))+"']").val();
            }
        }
        ...
        success: function(event) {
            ...
            $.ajax({
                ...
                success: function(resp){
                    ...
                    if(resp.popup_name != null && resp.popup_details != null)
                    {
                        $("#mount-bracket-anchor-paragraph-id").html('<a href="javascript:;" onclick="mount_popup_modal('+resp.id+')">'+resp.popup_name+'</a>');
                        // $("#myModal-mount-bracket").modal('show');
                        $(".mount-bracket-paragraph-details-class").html(resp.popup_details);
                    }

                    if(resp.image_link_id != null)
                    {
                        $("#new-mount-bracket-img-Qid").css('display','block');
...
$('.checking-radio-panel-of-slap-class input:radio').change(function() {
    ...
    {
        $("#mount-brackets-datas-show-id").html('<option value="">Choose a post mount brackets</option><option value="1">Concrete setup</option><option value="2">Existing slab setup</option>');
...
$("#fifth-page-to-next-id").click(function() {
...

    {
...

        {
            ...
            {
                error_pass_alert_show_msg("Please choose a post mount bracket");
            }
            else
            {
...

{
    ...
    $.ajax({
        ...
        success: function(event) {
            ...
            $.ajax({
                url: "{{ route('satirtha.post-canopy-img-video') }}",
                type: "GET",
                data: {choose_brackets: event.choose_canopy_post},
                dataType: "json",
                success: function(resp){
                    if(resp.video_link_id != null)
                    {
                        $("#youtube-canopy-video-id").css('display','block');
                        $("#youtube-canopy-video-id").html('<video width="1280" height="720" controls><source src="'+resp.video_link+'" type="video/mp4"></video>');
                    }
                    else 
                    {
                        $("#youtube-canopy-video-id").css('display','none');
                    ...
                    {
                        $("#new-post-canopy-img-Qid").css('display','block');
                        $("#new-post-canopy-img-Qid").html('<img loading="lazy" src="'+resp.image_link+'"  alt="post mount brackets" width="428" height="257" class="aligncenter size-full wp-image-3479">');
                    }
                    else 
                    {
                        $("#new-post-canopy-img-Qid").css('display','none');
                    ...
                    if(resp.popup_name != null && resp.popup_details != null)
                    {
                        $("#post-canopy-anchor-paragraph-id").html('<a href="javascript:;" onclick="canopy_popup_modal('+resp.id+')">'+resp.popup_name+'</a>');
                        // $("#myModal-mount-bracket").modal('show');
                        $(".post-canopy-paragraph-details-class").html(resp.popup_details);
                    }
...
$("#sixth-page-to-next-id").click(function() {
    ...
    else if(session_data_checking_for_louvered_panel == 'active')
    {
        if($("#pick-louvered-panel-hidden-session-id").val() == 0)
        {
            ...
            $.ajax({
                url: "{{ route('satirtha.post-lpanel-img-video') }}",
                type: "GET",
                data: {choose_brackets: event.choose_lpanel_post},
                dataType: "json",
                success: function(resp){
                    if(resp.lpanel_video_link_id != null)
                    {
                        $("#youtube-lpanel-video-id").css('display','block');
                        $("#youtube-lpanel-video-id").html('<video width="1280" height="720" controls><source src="'+resp.lpanel_video_link+'" type="video/mp4"></video>');
                    }
                    else 
                    {
                        $("#youtube-lpanel-video-id").css('display','none');
                    ...
                    if(resp.lpanel_image_link_id != null)
                    {
                        $("#new-post-lpanel-img-Qid").css('display','block');
                        $("#new-post-lpanel-img-Qid").html('<img loading="lazy" src="'+resp.lpanel_image_link+'"  alt="post mount brackets" width="428" height="257" class="aligncenter size-full wp-image-3479">');
                    }
                    else 
                    {
                        $("#new-post-lpanel-img-Qid").css('display','none');
                    ...
                    if(resp.popup_name != null && resp.popup_details != null)
                    {
                        $("#post-lpanel-anchor-paragraph-id").html('<a href="javascript:;" onclick="louvered_popup_modal('+resp.id+')">'+resp.popup_name+'</a>');
                        // $("#myModal-mount-bracket").modal('show');
                        $(".post-lpanel-paragraph-details-class").html(resp.popup_details);
                    }
...
function checkbox_lpanel_fx(side_part, side_price)
{
    ...
    if(side_part == "side1")
    {
        if($("#lpanel-checkbox-side1-count-id").val() == 0)
        {
            ...
            $("#lpanel-hide-radio-btn-panel-price-id").val(change_price.toFixed(2));
            $("#pergola-louvered-panel-price-id").html(change_price.toFixed(2));
    ...
    if(side_part == "side5")
    {
        if($("#lpanel-checkbox-side5-count-id").val() == 0)
        {
            var change_status = 1;
            $("#lpanel-checkbox-side5-count-id").val(change_status);
            var lHiddenPrice = parseFloat($("#lpanel-hide-radio-btn-panel-price-id").val());
            var sidePrice = parseFloat(side_price);
            var change_price = lHiddenPrice + sidePrice;
            $("#lpanel-hide-radio-btn-panel-price-id").val(change_price.toFixed(2));
        ...
        else if($("#lpanel-checkbox-side5-count-id").val() == 1)
        {
            var change_status = 0;
            $("#lpanel-checkbox-side5-count-id").val(change_status);
            var lHiddenPrice = parseFloat($("#lpanel-hide-radio-btn-panel-price-id").val());
    ...
    if(side_part == "side6")
    {
        if($("#lpanel-checkbox-side6-count-id").val() == 0)
        {
            var change_status = 1;
            $("#lpanel-checkbox-side6-count-id").val(change_status);
            var lHiddenPrice = parseFloat($("#lpanel-hide-radio-btn-panel-price-id").val());
            var sidePrice = parseFloat(side_price);
            var change_price = lHiddenPrice + sidePrice;
            $("#lpanel-hide-radio-btn-panel-price-id").val(change_price.toFixed(2));
        ...
        else if($("#lpanel-checkbox-side6-count-id").val() == 1)
        {
            var change_status = 0;
            $("#lpanel-checkbox-side6-count-id").val(change_status);
            var lHiddenPrice = parseFloat($("#lpanel-hide-radio-btn-panel-price-id").val());
    ...
    if(side_part == "side7")
    {
        if($("#lpanel-checkbox-side7-count-id").val() == 0)
        {
            var change_status = 1;
            $("#lpanel-checkbox-side7-count-id").val(change_status);
            var lHiddenPrice = parseFloat($("#lpanel-hide-radio-btn-panel-price-id").val());
            var sidePrice = parseFloat(side_price);
            var change_price = lHiddenPrice + sidePrice;
            $("#lpanel-hide-radio-btn-panel-price-id").val(change_price.toFixed(2));
        ...
        else if($("#lpanel-checkbox-side7-count-id").val() == 1)
        {
            var change_status = 0;
            $("#lpanel-checkbox-side7-count-id").val(change_status);
            var lHiddenPrice = parseFloat($("#lpanel-hide-radio-btn-panel-price-id").val());
    ...
    if(side_part == "side8")
    {
        if($("#lpanel-checkbox-side8-count-id").val() == 0)
        {
            var change_status = 1;
            $("#lpanel-checkbox-side8-count-id").val(change_status);
            var lHiddenPrice = parseFloat($("#lpanel-hide-radio-btn-panel-price-id").val());
            var sidePrice = parseFloat(side_price);
            var change_price = lHiddenPrice + sidePrice;
            $("#lpanel-hide-radio-btn-panel-price-id").val(change_price.toFixed(2));
        ...
        else if($("#lpanel-checkbox-side8-count-id").val() == 1)
        {
            var change_status = 0;
            $("#lpanel-checkbox-side8-count-id").val(change_status);
            var lHiddenPrice = parseFloat($("#lpanel-hide-radio-btn-panel-price-id").val());
...

{
    ...
    // mount bracket
        ...
        var lpanel_side5 = $("#lpanel-checkbox-side5-count-id").val();
        var lpanel_side6 = $("#lpanel-checkbox-side6-count-id").val();
        var lpanel_side7 = $("#lpanel-checkbox-side7-count-id").val();
        var lpanel_side8 = $("#lpanel-checkbox-side8-count-id").val();
        if(louvered_panel_details == null || louvered_panel_details == "" || louvered_panel_details == "no")
        {
            var lpanel_side1 = $("#lpanel-checkbox-side1-count-id").val();
            var lpanel_side2 = $("#lpanel-checkbox-side2-count-id").val();
    ...
    $.ajax({
        ...
        data: {
            ...
            lpanel_side5: lpanel_side5,
            lpanel_side6: lpanel_side6,
            lpanel_side7: lpanel_side7,
            lpanel_side8: lpanel_side8,
...
function mount_brackets_type_change_fx()
{
    ...
    {
        var mountB = "Pick Slab*";
        $("#mount-bracket-pick-slap-name-id").html(mountB);
    }
}
</script>
<script>
    // <a href="javascript:;" onclick=send_form_cc_fx('+(parseInt(count_cal)+parseInt(1))+') ><i class="fa fa-trash"></i></a>
    function send_form_cc_email_fx(data_type)
    {
        if(data_type == "add")
        {
            var email_address = $("#send-form-cc-email-id").val();
            if(email_address == "")
            {
                error_pass_alert_show_msg("Please add an email address");
            }
            else
            {
                var send_cc_email = $("#send-form-cc-email-id").val();
                var count_cal = $("#send-cc-emails-others-id").val();
                $(".send-cc-email-div").append('<p class="send-cc-emails-class" id="send-cc-emails-id'+(parseInt(count_cal)+parseInt(1))+'" >'+send_cc_email+'<input type="hidden" name="send_cc_emails_name'+(parseInt(count_cal)+parseInt(1))+'" value="'+send_cc_email+'" /></p>');
                var total_hidden_add = parseInt(count_cal)+parseInt(1);
                $("#send-cc-emails-others-id").val(total_hidden_add);
                $("#send-form-cc-email-id").val("");
            }
        }
        else if(data_type == "clear")
        {
            $(".send-cc-email-div").empty();
            $("#send-cc-emails-others-id").val(0);
        }
    }

    // function send_form_cc_fx(id)
    // {
    //     $("#send-cc-emails-id"+id).remove();
    // }

    function send_form_cc_email2_fx(data_type)
    {
        if(data_type == "add")
        {
            var email_address = $("#send-form-cc-email2-id").val();
            if(email_address == "")
            {
                error_pass_alert_show_msg("Please add an email address");
            }
            ...
            {
                var send_cc_email = $("#send-form-cc-email2-id").val();
                var count_cal = $("#send-cc-emails2-others-id").val();
                $(".send-cc-email2-div").append('<p class="send-cc-email2-class" id="send-cc-emails2-id'+(parseInt(count_cal)+parseInt(1))+'" >'+send_cc_email+'<input type="hidden" name="send_cc_emails2_name'+(parseInt(count_cal)+parseInt(1))+'" value="'+send_cc_email+'" /></p>');
                var total_hidden_add = parseInt(count_cal)+parseInt(1);
                $("#send-cc-emails2-others-id").val(total_hidden_add);
                $("#send-form-cc-email2-id").val("");
            }
        }
        else if(data_type == "clear")
        {
            $(".send-cc-email2-div").empty();
            $("#send-cc-emails2-others-id").val(0);
        }
    }


    // mount bracket popup
    function mount_popup_modal(id)
    {
        $("#myModal-mount-bracket").modal('show');
    }

    // post canopy popup
    function canopy_popup_modal(id)
    {
        $("#myModal-post-canopy").modal('show');
    }

    // post louvered popup
    function louvered_popup_modal(id)
    {
        $("#myModal-post-lpanel").modal('show');
    }
</script>
@endsection